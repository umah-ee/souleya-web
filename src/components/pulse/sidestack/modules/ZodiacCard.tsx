...
export default function ZodiacCard({ birthday }: Props) {
  ...
  if (!zodiac) {
    return (
      <div className="h-full flex flex-col items-center justify-center gap-2 text-center px-4">
        <Icon name="star" size={24} style={{ color: 'var(--text-muted)' }} />
  ...
  return (
    <div className="h-full flex flex-col gap-2 p-4 relative">
      {/* Gold Glow */}
      <div
