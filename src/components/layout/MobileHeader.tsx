...
export default function MobileHeader() {
  return (
    <header className="md:hidden sticky top-0 z-10 flex items-center justify-between px-5 py-3 bg-dark-est/95 backdrop-blur-xl border-b border-gold-1/10">
      ...
      <Link
        href="/profile"
        className="w-8 h-8 rounded-full bg-gold-1/10 border border-gold-1/20 flex items-center justify-center text-gold-1/60 hover:border-gold-1/40 transition-colors"
      >
