...
export const TOPICS: Record<string, Topic> = {
  wachstum: {
    ...
    img: 'https://images.unsplash.com/photo-1470252649378-9c29740c9fa8?w=1600&h=900&fit=crop&fm=webp&q=80',
    subs: [
      {
        name: 'Glaubenssätze auflösen',
        desc: 'Erkenne und verändere die unsichtbaren Muster, die dich zurückhalten.',
        img: 'https://images.unsplash.com/photo-1519681393784-d120267933ba?w=800&h=500&fit=crop&fm=webp&q=80',
        x: 14, y: 22,
        blog: {
          cat: 'Wachstum',
          time: '6 Min',
      ...
      },
      {
        ...
        img: 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=800&h=500&fit=crop&fm=webp&q=80',
        x: 68, y: 18, flip: true,
        blog: {
          cat: 'Selbstliebe',
          time: '5 Min',
      ...
      },
      {
        ...
        img: 'https://images.unsplash.com/photo-1484627147104-f5197bcd6651?w=800&h=500&fit=crop&fm=webp&q=80',
        x: 38, y: 48,
        blog: {
          cat: 'Routinen',
          time: '7 Min',
      ...
      },
      {
        ...
        img: 'https://images.unsplash.com/photo-1505455184862-554165e5f6ba?w=800&h=500&fit=crop&fm=webp&q=80',
        x: 62, y: 44, flip: true,
        blog: {
          cat: 'Resilienz',
          time: '8 Min',
      ...
      },
      {
        ...
        img: 'https://images.unsplash.com/photo-1517842645767-c639042777db?w=800&h=500&fit=crop&fm=webp&q=80',
        x: 18, y: 72,
        blog: {
          cat: 'Journaling',
          time: '5 Min',
  ...
  gesundheit: {
    ...
    img: 'https://images.unsplash.com/photo-1706267701238-b4d69fc8f640?w=1600&h=900&fit=crop&fm=webp&q=80',
    subs: [
      {
        name: 'Nervensystem & Stress',
        desc: 'Lerne, dein Nervensystem bewusst zu regulieren.',
        img: 'https://images.unsplash.com/photo-1518241353330-0f7941c2d9b5?w=800&h=500&fit=crop&fm=webp&q=80',
        x: 16, y: 20,
        blog: {
          cat: 'Gesundheit',
          time: '7 Min',
      ...
      },
      {
        ...
        img: 'https://images.unsplash.com/photo-1501785888041-af3ef285b470?w=800&h=500&fit=crop&fm=webp&q=80',
        x: 66, y: 16, flip: true,
        blog: {
          cat: 'Schlaf',
          time: '6 Min',
      ...
      },
      {
        ...
        img: 'https://images.unsplash.com/photo-1470071459604-3b5ec3a7fe05?w=800&h=500&fit=crop&fm=webp&q=80',
        x: 36, y: 50,
        blog: {
          cat: 'Gesundheit',
          time: '8 Min',
      ...
      },
      {
        ...
        img: 'https://images.unsplash.com/photo-1508672019048-805c876b67e2?w=800&h=500&fit=crop&fm=webp&q=80',
        x: 60, y: 48, flip: true,
        blog: {
          cat: 'Mental Health',
          time: '6 Min',
      ...
      },
      {
        ...
        img: 'https://images.unsplash.com/photo-1476231682828-37e571bc172f?w=800&h=500&fit=crop&fm=webp&q=80',
        x: 20, y: 74,
        blog: {
          cat: 'Burnout',
          time: '9 Min',
  ...
  worklife: {
    ...
    img: 'https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=1600&h=900&fit=crop&fm=webp&q=80',
    subs: [
      {
        name: 'Remote Work optimieren',
        desc: 'Arbeite von überall – ohne die Struktur zu verlieren.',
        img: 'https://images.unsplash.com/photo-1551966775-a4ddc8df052b?w=800&h=500&fit=crop&fm=webp&q=80',
        x: 14, y: 18,
        blog: {
          cat: 'Remote Work',
          time: '6 Min',
      ...
      },
      {
        ...
        img: 'https://images.unsplash.com/photo-1504439468489-c8920d796a29?w=800&h=500&fit=crop&fm=webp&q=80',
        x: 64, y: 22, flip: true,
        blog: {
          cat: 'Finanzen',
          time: '7 Min',
      ...
      },
      {
        ...
        img: 'https://images.unsplash.com/photo-1488190211105-8b0e65b80b4e?w=800&h=500&fit=crop&fm=webp&q=80',
        x: 34, y: 52,
        blog: {
          cat: 'Produktivität',
          time: '8 Min',
      ...
      },
      {
        ...
        img: 'https://images.unsplash.com/photo-1499750310107-5fef28a66643?w=800&h=500&fit=crop&fm=webp&q=80',
        x: 62, y: 46, flip: true,
        blog: {
          cat: 'Grenzen',
          time: '5 Min',
      ...
      },
      {
        ...
        img: 'https://images.unsplash.com/photo-1521737604893-d14cc237f11d?w=800&h=500&fit=crop&fm=webp&q=80',
        x: 18, y: 76,
        blog: {
          cat: 'Purpose',
          time: '7 Min',
  ...
  spiritualitaet: {
    ...
    img: 'https://images.unsplash.com/photo-1597682886233-61b9023db181?w=1600&h=900&fit=crop&fm=webp&q=80',
    subs: [
      {
        name: 'Meditation & Atemübungen',
        desc: 'Finde Stille – selbst im lautesten Moment.',
        img: 'https://images.unsplash.com/photo-1545389336-cf090694435e?w=800&h=500&fit=crop&fm=webp&q=80',
        x: 16, y: 20,
        blog: {
          cat: 'Meditation',
          time: '6 Min',
      ...
      },
      {
        ...
        img: 'https://images.unsplash.com/photo-1499209974431-9dddcece7f88?w=800&h=500&fit=crop&fm=webp&q=80',
        x: 66, y: 16, flip: true,
        blog: {
          cat: 'Achtsamkeit',
          time: '5 Min',
      ...
      },
      {
        ...
        img: 'https://images.unsplash.com/photo-1516450360452-9312f5e86fc7?w=800&h=500&fit=crop&fm=webp&q=80',
        x: 36, y: 50,
        blog: {
          cat: 'Human Design',
          time: '9 Min',
      ...
      },
      {
        ...
        img: 'https://images.unsplash.com/photo-1475924156734-496f6cac6ec1?w=800&h=500&fit=crop&fm=webp&q=80',
        x: 60, y: 44, flip: true,
        blog: {
          cat: 'Manifestation',
          time: '6 Min',
      ...
      },
      {
        ...
        img: 'https://images.unsplash.com/photo-1533577116850-9cc66cad8a9b?w=800&h=500&fit=crop&fm=webp&q=80',
        x: 20, y: 74,
        blog: {
          cat: 'Astrologie',
          time: '7 Min',
  ...
  beziehungen: {
    ...
    img: 'https://images.unsplash.com/photo-1758524945869-24a53c8cbc1e?w=1600&h=900&fit=crop&fm=webp&q=80',
    subs: [
      {
        name: 'Einsamkeit überwinden',
        desc: 'Du bist nicht allein – du hast nur noch nicht die richtigen gefunden.',
        img: 'https://images.unsplash.com/photo-1445543949571-ffc3e0e2f55e?w=800&h=500&fit=crop&fm=webp&q=80',
        x: 14, y: 22,
        blog: {
          cat: 'Verbindung',
          time: '7 Min',
      ...
      },
      {
        ...
        img: 'https://images.unsplash.com/photo-1543807535-eceef0bc6599?w=800&h=500&fit=crop&fm=webp&q=80',
        x: 65, y: 18, flip: true,
        blog: {
          cat: 'Freundschaft',
          time: '5 Min',
      ...
      },
      {
        ...
        img: 'https://images.unsplash.com/photo-1516589178581-6cd7833ae3b2?w=800&h=500&fit=crop&fm=webp&q=80',
        x: 36, y: 50,
        blog: {
          cat: 'Bindung',
          time: '8 Min',
      ...
      },
      {
        ...
        img: 'https://images.unsplash.com/photo-1522202176988-66273c2fd55f?w=800&h=500&fit=crop&fm=webp&q=80',
        x: 62, y: 46, flip: true,
        blog: {
          cat: 'Kommunikation',
          time: '6 Min',
      ...
      },
      {
        ...
        img: 'https://images.unsplash.com/photo-1528715471579-d1bcf0ba5e83?w=800&h=500&fit=crop&fm=webp&q=80',
        x: 18, y: 74,
        blog: {
          cat: 'Grenzen',
          time: '5 Min',
