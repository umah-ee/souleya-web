        ...
        <>
          ...
          <div className="grid gap-4 mb-8" style={{ gridTemplateColumns: 'repeat(auto-fit, minmax(180px, 1fr))' }}>
            {[
              ...
              <div key={item.label} className="glass-card rounded-xl p-4" style={{ background: 'var(--card-bg)' }}>
          ...
          {coupons.length === 0 ? (
            ...
            <div className="flex flex-col gap-2 mb-8">
              {coupons.map((c) => (
                <div key={c.id} className="glass-card rounded-xl p-4 flex items-center gap-4" style={{ background: 'var(--card-bg)' }}>
          ...
          {payouts.length === 0 ? (
            ...
            <div className="flex flex-col gap-2">
              {payouts.map((p) => (
                <div key={p.id} className="glass-card rounded-xl p-4 flex items-center gap-4" style={{ background: 'var(--card-bg)' }}>
